...
#
# build   - build lib sources to web/src/{{lib}}
  ...
  @initConfig
    ...
    browserify:
      dist:
        ...
        dest: "web/src/#{$packageName}/#{$packageName}.js"
      example:
        options:
          browserifyOptions:
            debug: true
        ...
        dest: "web/src/example/example.js"
    ...
    uglify:
      dist:
        cwd: __dirname
        src: ["web/src/#{$packageName}/#{$packageName}.js"]
        dest: "web/src/#{$packageName}/#{$packageName}.min.js"
    ...
    copy:
      ...
      build:
        expand: true
        cwd: __dirname
        src: ["web/frameworks/cocos2d-html5/**/*.*", "web/src/**/*.*", "web/res/**/*.*", "web/index.html", "web/main.js", "web/project.json", "web/manifest.webapp"]
        dest: "build/"
